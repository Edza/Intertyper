...
import HelloWorld from '@/components/Questions.vue'
...
describe('Questions.vue', () => {
  it('renders props.msg when passed', () => {
    ...
    const isRandomQuestion: boolean = false
    const wrapper = shallowMount(HelloWorld, {
      propsData: { isRandomQuestion }
    })
    expect(wrapper.text()).to.include('not supported')
  })
})
